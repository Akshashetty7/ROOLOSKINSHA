...
export default function Profile() {
  ...
  if (localStorage.getItem('isDev')) {
    return (
      <div className="flex flex-col max-w-screen-sm md:max-w-none lg:max-w-none items-center justify-center mx-3 bg-orange-100 ">
        <div
        ...
        >
          <div className="flex justify-start lg:items-center w-full mt-6 items-start  place-content-start md:gap-[5%] border-b border-slate-300 px-5 py-7 relative">
            ...
            <div className="flex flex-col justify-between lg:pb-16 h-full  gap-3">
              {/* --------Developer Name------------------- */}
              <h1 className="text-3xl lg:text-5xl font-medium text-slate-900 capitialize">
                {developer?.fname}
                {' '}
                {developer?.lname}
              </h1>
